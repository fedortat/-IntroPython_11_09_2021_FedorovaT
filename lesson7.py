###################################### импорт из файла
# from lesson5_hw import create_email
#
...
#
# with open("test2.csv", "w", encoding="utf-8") as csv_file:
...
#     fieldnames = ["Column1", "Column2", "Column3", "Total",]
#     print(f"{fieldnames=}")
...
# print(sort_temp)
#
# words = ["ajsyg", "jasy", "Qe", "124", "flgvnjb", "d"]
